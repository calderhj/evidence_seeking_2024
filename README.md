...
There are two scripts for Experiment 1, one for chimpanzee data and another for data with 4-year-old human children.
...
Another script has the code for all inter-rater reliability tests performed accross all instances of Experiment 1 and 2.
